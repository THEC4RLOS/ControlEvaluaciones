<?php
//por medio de este archivo se realiza la consulta a la base de datos sobre los
//cursos pertenecientes al usuario dado un numero de cedula
$user = $_REQUEST["user"];//numero de cedula para realizar la consulta
